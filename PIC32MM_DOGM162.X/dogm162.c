...
void WlaczLCD()
{
  ...
  Wyslij_do_LCD(0x30);/*Function Set 8 bit DL=1 IS2/IS1=0*/
   delayUs(30);
  Wyslij_do_LCD(0x20);/*Function Set 4 bit DL = 0*/
   delayUs(30);
  Wyslij_do_LCD(0x29);/*Function Set 4 bit DL=1 IS2=0/IS1=1*/
   delayUs(30);
  Wyslij_do_LCD(0x14);/*Bias set*/
   delayUs(30);
  Wyslij_do_LCD(0x78);/*Contrast set*/
  delayUs(30); 
  Wyslij_do_LCD(0x5D);/*Power/Icon control*/
  delayUs(30);
   Wyslij_do_LCD(0x6D);/*Follower control*/
  delayUs(30);
  Wyslij_do_LCD(0x0C);/*DISPLAY ON, CURSOR OFF , CURSOR BLINK OFF*/
  delayUs(30);
  Wyslij_do_LCD(0x01);/*Clear Display*/
  delayMs(2);
  Wyslij_do_LCD(0x28);/*Function Set 4 bit DL=1 IS2/IS1=0*/
  delayUs(30);
  Wyslij_do_LCD(0x06);/*Entry mode set, Cursor auto-increment*/
  delayUs(30);
